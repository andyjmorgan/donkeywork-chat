...
const StringFormatterNode = ({ id, data, selected }: NodeProps) => {
  ...
  return (
    <>
      <BaseNode data={{...data, nodeType: NodeTypeEnum.STRING_FORMATTER}} className={!validationResult.valid ? 'invalid-node' : ''}>
              ...
              if (connectedInputs.length === 0) {
                return (
                  <div style={{
                    ...
                    No connected input nodes found. Connect nodes to this formatter to use their values.</p>
                  </div>
                );
              }
