...
[JsonDerivedType(typeof(SerpApiConfiguration), typeDiscriminator: nameof(SerpApiConfiguration))]
public abstract class BaseGenericProviderConfiguration
{
    ...
    public static BaseGenericProviderConfiguration GetConfigurationByProviderType(ToolProviderType providerType)
    {
        var providers = ToolProviderDefinition.GetToolProviders();
        return providers[providerType].ProviderConfiguration!;
    }
    ...
    protected GenericProviderConfigurationModel CreateGenericProviderConfiguration(ToolProviderType providerType)
    {
